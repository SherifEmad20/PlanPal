...
export default function UpdateVenue() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      await api.post(`/venue/updateVenue`, formData, {
        headers: {
      ...
      <MDBContainer
        ...
        <MDBRow>
          ...
          <MDBCol col="6" className="mb-5">
            ...
            <MDBInput required onChange={handlePhoneChange} />
          </MDBCol>
          ...
          <MDBCol col="6" className="mb-5">
            ...
            <MDBInput required onChange={handleCapacityChange} />
          </MDBCol>
        </MDBRow>
        ...
        <MDBRow>
          <MDBCol col="6" className="mb-5">
            <label>Price:</label>
            <MDBInput required onChange={handlePriceChange} />
          </MDBCol>
